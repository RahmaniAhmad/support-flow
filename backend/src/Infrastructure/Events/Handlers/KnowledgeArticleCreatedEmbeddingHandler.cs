...
public sealed class KnowledgeArticleCreatedEmbeddingHandler
    : INotificationHandler<KnowledgeArticleCreatedDomainEvent>
{
    ...
    private readonly ILogger<KnowledgeArticleCreatedEmbeddingHandler> _logger;

    public KnowledgeArticleCreatedEmbeddingHandler(
        IEmbeddingService embeddingService,
        IVectorStore vectorStore,
        ILogger<KnowledgeArticleCreatedEmbeddingHandler> logger)
    {
